...
#args = get_arguments()
# with open("nq_finetune.pkl","r")as f:
#     data = pickle.load(f)
from torch.serialization import default_restore_location
# model = BiBertEncoder(args)
# state_dict = torch.load("nq_fintinue.pkl", map_location=lambda s, l: default_restore_location(s, 'cpu'))
# model.load_state_dict(state_dict.model_dict, strict=False)
#
