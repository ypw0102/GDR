...
class T5Attention(nn.Module):
    def __init__(self, config: T5Config, has_relative_attention_bias=False, is_bidirectional=False,is_cross=False):
        super().__init__()
        self.cross = is_cross
    ...
    def compute_bias(self, qlen, klen):
        ...
        # print("********1")
        # print(self.is_bidirectional)
        # print("*************2")
        # print(self.relative_attention_num_buckets)
        # print("*******************3")
        # print(relative_position.size())
        # print("************************4")
        ...
        # print("Over!!!!!!!!!!!!!!!!!")
        # print("self.relative_attention_bias.weight.device")
...
class T5LayerCrossAttention(nn.Module):
    def __init__(self, config, has_relative_attention_bias=False):
        ...
        self.EncDecAttention = T5Attention(
            config, has_relative_attention_bias=has_relative_attention_bias, is_bidirectional=True,is_cross=True
        )
        self.layer_norm = T5LayerNorm(config.d_model, eps=config.layer_norm_epsilon)
        self.dropout = nn.Dropout(config.dropout_rate)
...
class T5Stack(T5PreTrainedModel):
    ...
    def forward(
        ...
        if inputs_embeds is None:
            ...
            if self.training and self.is_decoder and len(input_ids)==1:
...
@add_start_docstrings(
    "The "
    "bare T5 Model transformer outputting raw hidden-states" "without any specific head on top.",
    T5_START_DOCSTRING,
)
